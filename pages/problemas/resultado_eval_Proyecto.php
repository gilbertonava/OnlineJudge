            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-4 col-lg-12">
                        <h1 class="page-header">Resultados del Proyecto</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                ...
                <div class="row">
                    ...
                    <img class="img-thumbnail col-md-offset-2 col-lg-offset-4" 
                         src="../../static/images/eval.jpg" height="200" width="200" />                   
                ...
                <div class="panel-body">
                    <div class="dataTable_wrapper">
                        <table class="table table-striped table-bordered table-hover" 
                            ...
                            <tbody>
                                <tr class="odd gradeX">
                                    <td width="40px"><b>Usuario:</b></td>
                                    <td>[el usuario]</td>
                                   

                                </tr>
                                <tr class="odd gradeX">
                                    <td width="40px"><b>Problema:</b></td>
                                    <td>[el problema]</td>
                                ...
                                <tr class="even gradeA">
                                    <td width="40px"><b>Puntos Obtenidos:</b></td>
