                        ...
                        <div class="panel-heading">
                           ...
                           <div class="form-group text-right">
                                ...
                                <button  type="button" class="btn btn-success"  
                                         onClick=" window.location.href='crearMateria_merce.html' ">Registrar Nuevo</button>   
                        </div>
                          </div>
                        <!-- /.panel-heading -->
                                            ...
                                            <td>5</td>
                                                ...
                                                <div class="toolbar text-center" role="toolbar">
                                                    ...
                                                    <div class="btn-group" role="group">
                                                        <button class="btn btn-sm btn-primary col-md-offset-2" id="editar" 
                                                                style="padding-right:10px"><i class="glyphicon glyphicon-edit" 
                                                                                      onClick=" window.location.href='gestionMaterias_merce.html' ">
