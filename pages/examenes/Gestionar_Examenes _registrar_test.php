                    ...
                    <div class="btn-group">
                        <div class="btn-group" role="group">
                            <button class="btn btn-sm btn-circle btn-pinterest btn-success col-md-offset-2" 
                                    id="return" onclick="window.open('gestionarExamenes.html', '_self', 'false')">
                                        ...
                                        <div class="panel-body">
                                            <form role="form" action="gestionarExamenes.html" method="post">
                                                ...
                                                <div class=" form-group col-md-offset-3" align="right">
                                                    <button type="submit" id="btn-cancel-registrarMateria" class="btn btn-outline btn-danger">Cancelar</button>
