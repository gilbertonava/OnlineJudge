        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p class="text-center text-danger">¿Estas seguro de querer eliminar este Usuario?</p>
                </div>
                                        ...
                                        <tr class="odd gradeA">
                                            ...
                                            <td>Alumno</td>
                                                ...
                                                <div class="toolbar text-center" role="toolbar">
                                                    ...
                                                    <div class="btn-group" role="group"><button class="btn btn-sm btn-primary col-md-offset-2" id="editar" style="padding-right:10px"><i class="glyphicon glyphicon-edit" onClick=" window.location.href='Modificar_Usuario.html' "></i></button></div>
